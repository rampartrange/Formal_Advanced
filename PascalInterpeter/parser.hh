...
/**
 ** \file /Users/rampartrange/CompilersCourse/03-parsers-with-ast/parser.hh
...
#ifndef YY_YY_USERS_RAMPARTRANGE_COMPILERSCOURSE_03_PARSERS_WITH_AST_PARSER_HH_INCLUDED
# define YY_YY_USERS_RAMPARTRANGE_COMPILERSCOURSE_03_PARSERS_WITH_AST_PARSER_HH_INCLUDED
// "%code requires" blocks.
#line 9 "/Users/rampartrange/CompilersCourse/03-parsers-with-ast/parser.y"
...
#line 72 "/Users/rampartrange/CompilersCourse/03-parsers-with-ast/parser.hh"
...
namespace yy {
#line 206 "/Users/rampartrange/CompilersCourse/03-parsers-with-ast/parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_RPAREN = 268,              // ")"
    TOK_i = 269,                   // i
    TOK_IDENTIFIER = 270,          // "identifier"
    TOK_NUMBER = 271,              // "number"
    TOK_CMP = 272,                 // CMP
    TOK_UMINUS = 273               // UMINUS
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_unit = 20,                             // unit
        S_assignments = 21,                      // assignments
        S_assignment = 22,                       // assignment
        S_exp = 23                               // exp
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        YY_ASSERT (tok == token::TOK_END
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_i)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_i (location_type l)
      {
        return symbol_type (token::TOK_i, std::move (l));
      }
#else
      static
      symbol_type
      make_i (const location_type& l)
      {
        return symbol_type (token::TOK_i, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_CMP (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CMP, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CMP (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CMP, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1756 "/Users/rampartrange/CompilersCourse/03-parsers-with-ast/parser.hh"




#endif // !YY_YY_USERS_RAMPARTRANGE_COMPILERSCOURSE_03_PARSERS_WITH_AST_PARSER_HH_INCLUDED
